  ...
  items.forEach((item) => {
    item.addEventListener("click", () => {
      items.forEach((i) => {
        ...
        if (imageDiv)
          imageDiv.classList.remove("animate__animated", "animate__fadeInDown");
        if (infoDiv)
          infoDiv.classList.remove("animate__animated", "animate__fadeInUp");
      });
      item.classList.add("active");
      ...
      if (imageDiv)
        imageDiv.classList.add("animate__animated", "animate__fadeInDown");
      if (infoDiv)
        infoDiv.classList.add("animate__animated", "animate__fadeInUp");
    });
  });
});
...
$(document).ready(function () {
  ...
  $(".home_banner_content_tabs:first")
    .show()
    .addClass("show")
    .animate({ opacity: 1 }, 1000);
